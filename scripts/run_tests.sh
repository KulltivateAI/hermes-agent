...
#   * HERMES_DOCKER_RUN_TIMEOUT is read by the QEMU-only Docker smoke test to
#     bound slow emulated process startup without changing native defaults.
#
